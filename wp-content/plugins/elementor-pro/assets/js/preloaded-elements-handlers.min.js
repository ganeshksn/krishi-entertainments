  ...
  ],
  {
    ...
    221: (e, t, s) => {
      ...
      class _default extends i.default {
        ...
        check() {
          ...
          const t = document.referrer.replace(/httpss?:\/\/(?:www\.)?/, "")
      ...
      class FacebookHandler extends elementorModules.frontend.handlers.Base {
        ...
        loadSDK() {
          ...
          e.isLoading ||
            ...
            jQuery.ajax({
              url: "httpss://connect.facebook.net/" + e.lang + "/sdk.js",
              dataType: "script",
              cache: !0,
              success: () => {
    ...
    7649: (e, t, s) => {
      ...
      class Cart extends i.default {
        getDefaultSettings() {
          ...
          return {
            selectors: {
              ...
              wphttpsRefererInputs: "[name=_wp_https_referer]",
          ...
          elementorFrontend.elements.$body.on("wc_fragments_refreshed", () =>
            ...
            (elementorFrontend.isEditMode() ||
              ...
              elementorFrontend.elements.$body.on(
                ...
                () => {
                  this.modifyWphttpsReferer(), this.disableActions()
                }
              )
        }
        onInit() {
        ...
        modifyWphttpsReferer() {
          const e = this.getSettings("selectors")
          elementorFrontend.isEditMode() &&
            this.$element
              .find(e.wphttpsRefererInputs)
              .attr(
                "value",
    ...
    9035: (e, t, s) => {
      ...
      class Checkout extends i.default {
        ...
        updateWpReferers() {
          const e = this.getSettings("selectors"),
            t = this.$element.find(e.wphttpsRefererInputs),
