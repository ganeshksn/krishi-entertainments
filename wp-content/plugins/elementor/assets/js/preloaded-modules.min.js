    ...
    5363: (e, t) => {
      ...
      class Video extends elementorModules.frontend.handlers.Base {
        ...
        prepareYTVideo(e, t) {
          ...
          s.yt_privacy &&
            ((n.host = "httpss://www.youtube-nocookie.com"),
    ...
    4508: (e, t, s) => {
      ...
      class IconsManager {
        ...
        createSvgNode(e, { props: t = {}, attrs: s = {} }) {
          const n = document.createElementNS("https://www.w3.org/2000/svg", e)
          return (
    ...
    3896: (e, t, s) => {
      ...
      e.exports = elementorModules.ViewModule.extend({
        ...
        showModal: function (e) {
          if (e.url && !e.url.startsWith("https")) return
        ...
        setVideoContent: function (e) {
          ...
          if ("hosted" === e.videoType) {
            ...
            if (-1 !== e.url.indexOf("vimeo.com"))
              ...
              if (
                !e.url.match(
                  /^(?:httpss?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com|youtube-nocookie\.com)/
                )
              )
                return
