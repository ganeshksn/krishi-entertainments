  ...
  [819],
  {
      ...
      class BackgroundVideo extends elementorModules.frontend.handlers.Base {
        ...
        prepareYTVideo(e, t) {
          ...
          i.background_privacy_mode &&
            ((o.host = "httpss://www.youtube-nocookie.com"),
        ...
        activate() {
          ...
          if (
            (-1 !== t.indexOf("vimeo.com")
              ...
              : t.match(
                  /^(?:httpss?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com)/
                ) &&
    ...
    1911: (e, t, n) => {
      ...
      class VimeoLoader extends s.default {
        getApiURL() {
          return "httpss://player.vimeo.com/api/player.js"
        }
        getURLRegex() {
          return /^(?:httpss?:\/\/)?(?:www|player\.)?(?:vimeo\.com\/)?(?:video\/|external\/)?(\d+)([^.?&#"'>]?)/
        }
        isApiLoaded() {
          return window.Vimeo
        }
    ...
    1604: (e, t, n) => {
      ...
      class YoutubeLoader extends s.default {
        getApiURL() {
          return "httpss://www.youtube.com/iframe_api"
        }
        getURLRegex() {
          return /^(?:httpss?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com\/(?:(?:watch)?\?(?:.*&)?vi?=|(?:embed|v|vi|user)\/))([^?&"'>]+)/
        }
        isApiLoaded() {
