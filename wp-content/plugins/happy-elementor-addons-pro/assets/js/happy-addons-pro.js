...
;(function ($, Happy, w) {
  ...
  $(function () {
    ...
    log("click", ".ha-dropdown-has > a", function (event) {
      if (
        !$(this)
          .parents(".ha-navbar-nav, .ha-vertical-navbar-nav")
        ...
        var $oElemDragged = $(this)
          .parent()
          .find(">.ha-dropdown, >.ha-megamenu-panel")
  ...
  $window.on("elementor/frontend/init", function () {
    if (
      typeof haDisplayCondition != "undefined" &&
      haDisplayCondition.status == "true"
    ) {
    ...
    var SliderBase = elementorModules.frontend.handlers.Base.extend({
      ...
      getReadySettings: function getReadySettings() {
        ...
        if (this.getElementSettings("thumbs_navigation") == "yes") {
          var selectorThumbs = this.elements.$container.find(
            ".ha-slider-gallery-thumbs"
          )
        ...
        var settings = {
          ...
          spaceBetween:
            parseInt(this.getElementSettings("space_between_slides")) || 0,
          loop: !!(this.getElementSettings("infinity_loop") || false),
          speed: parseInt(this.getElementSettings("effect_speed")),
          effect:
            this.getElementSettings("slider_type") == "multiple"
              ? this.getElementSettings("effect_multiple")
              : this.getElementSettings("effect"),
          ...
          $.each(breakpoints, function (idx, val) {
            if (val.is_enabled) {
              bpObj[idx] = {
                ...
                slidesPerView:
                  parseInt(
                    $this.getElementSettings("slides_per_view_" + idx)
                  ) || slidesPerView,
                spaceBetween:
                  parseInt(
                    $this.getElementSettings("space_between_slides_" + idx)
                  ) || 0,
              }
            }
          })
        ...
        if (this.getElementSettings("autoplay") == "yes") {
          settings.autoplay = {
            ...
            stopOnLastSlide: !(
              this.getElementSettings("infinity_loop") || false
            ),
          }
        }
        ...
        if (this.getElementSettings("pagination_type") == "dots") {
          var selectorPagi = this.elements.$container.find(
        ...
        if (this.getElementSettings("scroll_bar") == "yes") {
          var selectorScroll = this.elements.$container.find(
            ".ha-slider-scrollbar"
          )
          settings.scrollbar = {
            el: selectorScroll[0],
      ...
      run: function run() {
        ...
        if (readySettings.customMultiple) {
          $(window)
            .on("resize", function () {
              ...
              sliderObj.params.slidesPerView =
                readySettings.customBreakpoints[mode].slidesPerView
              sliderObj.params.spaceBetween =
                readySettings.customBreakpoints[mode].spaceBetween
              sliderObj.update()
            })
            .resize()
        }
        ...
        sliderObj.on("slideChange", function () {
          ...
          elSlide
            .eq(aI)
            .find(".elementor-invisible, .animated")
            .each(function (e, t) {
    ...
    var TimeLine = function TimeLine($scope) {
      ...
      var event =
        "scroll.timelineScroll" + T_ID + " resize.timelineScroll" + T_ID
        ...
        this.elements.$items.each(function (index, item) {
          ...
          $item.tipso({
            ...
            onBeforeShow: function onBeforeShow($e, e, tooltip) {
              $(document)
                .find(".elementor-repeater-item-" + target)
                .remove()
    ...
    var DataTable = function DataTable($scope) {
      ...
      if (dataTable.data("export-table") == true) {
        ...
        dataTableBtn.on("click", function () {
          var oldDownloadNode = document.querySelector(
    ...
    function productCarouselHandlerCallback($scope) {
      ...
      if (
        $scope.find(".ha-product-carousel-wrapper").hasClass("ha-layout-modern")
      ) {
        $scope
    ...
    var initOnePageNav = elementorModules.frontend.handlers.Base.extend({
      ...
      run: function run() {
        ...
        var track = false
        var $navWrapper =
          settings.design == "ha-opn-design-default"
            ? this.$element.find(".ha-opn-dotted-item")
            : this.$element.find(".ha_opn__item")
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/ha-mini-cart.default",
      miniCart
    )
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/ha-mini-cart.default",
    ...
    OffCanvas.prototype = {
      ...
      init: function init() {
        ...
        if ($(".ha-offcanvas-container").length === 0) {
          var faProJs =
            $("#font-awesome-pro-js").length > 0
              ? $("#font-awesome-pro-js").attr("src")
              : false
          ...
          if (faProJs) {
            $("body").append(
              '<script type="text/javascript" id="font-awesome-pro-js" src="' +
                faProJs +
                '"></script>'
            )
          }
        ...
        if (this.wrap.find(".ha-offcanvas-content").length > 0) {
          if (
            $(".ha-offcanvas-container > .ha-offcanvas-content-" + this.id)
              .length > 0
          ) {
            $(
              ".ha-offcanvas-container > .ha-offcanvas-content-" + this.id
      ...
      bindEvents: function bindEvents() {
        ...
        if (this.links_click_close === "yes") {
          $("body").delegate(
            ".ha-offcanvas-content .ha-offcanvas-body a",
            "click",
            $.proxy(this.close, this)
          )
        }
      ...
      show: function show() {
        $(".ha-offcanvas-content-" + this.id).addClass(
          "ha-offcanvas-content-visible"
      ...
      close: function close() {
        ...
        setTimeout(
          $.proxy(function () {
            ...
            $(".ha-offcanvas-content-" + this.id).removeClass(
              "ha-offcanvas-content-visible"
            )
          }, this),
          500
      ...
      closeClick: function closeClick() {
        ...
        $(document).on("click", function (e) {
          if (
            $(e.target).is(".ha-offcanvas-content") ||
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/ha-off-canvas.default",
      initOffCanvas
    )
    var Unfold = elementorModules.frontend.handlers.Base.extend({
      ...
      onElementChange: function onElementChange(e) {
        if (
          ...
          if (e == "fold_height") {
            this.$element
              .find(".ha-unfold-data")
              .css("height", this.getCollapseHeight() + "px")
          }
        }
      },
      getReadySettings: function getReadySettings() {
        var settings = {
          ...
          collapse_height_tablet:
            this.getElementSettings("fold_height_tablet") ||
            this.getElementSettings("fold_height") ||
            50,
          collapse_height_mobile:
            this.getElementSettings("fold_height_mobile") ||
            this.getElementSettings("fold_height_tablet") ||
            this.getElementSettings("fold_height") ||
            50,
          trigger: this.getElementSettings("trigger"),
          transition_duration:
            this.getElementSettings("transition_duration") || 500,
      ...
      fold: function fold(unfoldData, button, collapse_height) {
        var unfoldSettings = this.getReadySettings()
        var html = unfoldSettings.collapse_icon
          ? unfoldSettings.collapse_icon.value
            ? '<i aria-hidden="true" class="' +
              unfoldSettings.collapse_icon.value +
              '"></i>'
            : ""
          : ""
        html += unfoldSettings.collapse_text
          ? "<span>" + unfoldSettings.collapse_text + "</span>"
          : ""
        unfoldData.css(
          "transition-duration",
          unfoldSettings.transition_duration + "ms"
        )
        unfoldData.animate(
          {
      ...
      unfold: function unfold(unfoldData, unfoldRender, button) {
        var unfoldSettings = this.getReadySettings()
        var html = unfoldSettings.expand_icon
          ? unfoldSettings.expand_icon.value
            ? '<i aria-hidden="true" class="' +
              unfoldSettings.expand_icon.value +
              '"></i>'
            : ""
          : ""
        html += unfoldSettings.expand_text
          ? "<span>" + unfoldSettings.expand_text + "</span>"
          : ""
        unfoldData.css(
          "transition-duration",
          unfoldSettings.transition_duration + "ms"
    ...
    var Maps = elementorModules.frontend.handlers.Base.extend({
      ...
      mapInit: function mapInit(wrapper) {
        ...
        map = new google.maps.Map(
          document.querySelector(".ha-adv-google-map__wrapper" + wrapper),
          {
            center: {
            ...
            gestureHandling:
              settings.scrollWheelZoom === "yes" ? "greedy" : "cooperative",
            draggable: settings.mapDraggable !== "yes",
            styles:
              settings.mapStyle !== "custom"
                ? settings.defaultStyle[settings.mapStyle]
                : !this.isValidJsonString(settings.customMapStyles)
                ? ""
                : JSON.parse(settings.customMapStyles),
          }
        )
        ...
        markersOptionsArray.forEach(function (option) {
              ...
              option.pin_icon.url === ""
                ...
                : {
                    ...
                    scaledSize: new google.maps.Size(
                      option.rectangular_image === "yes"
                        ? +option.rectangular_pin_size_width.size
                        : +option.square_pin_size.size,
                      option.rectangular_image === "yes"
                        ? +option.rectangular_pin_size_height.size
                        : +option.square_pin_size.size
                    ),
                  },
            map: map,
          ...
          var infoWindow = new google.maps.InfoWindow({
            content:
              '<div class="ha-adv-google-map__marker-wrapper">' +
              '<div class="ha-adv-google-map__marker-title-wrapper">' +
              '<div class="ha-adv-google-map__marker-title" style="display: inline-block">' +
              option.pin_item_title +
              "</div>" +
              "</div>" +
              '<div class="ha-adv-google-map__marker-description-wrapper">' +
              '<div class="ha-adv-google-map__marker-description">' +
              option.pin_item_description +
              "</div>" +
              "</div>" +
              "</div>",
          })
    ...
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/ha-google-map.default",
      function ($scope) {
